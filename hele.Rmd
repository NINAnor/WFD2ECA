...
### Vannforekomster
Fila over vannforekomster må lastes ned som en excel-fil (csv) fra vann-nett:
...
Denne fila er nødvendig for å lese inn vannforekomstdataene, og den ligger i dette arkivet under navnet "**NavnVN.csv**".
...
Denne fila er nødvendig for å lese inn innsjødataene, og den ligger i dette arkivet under navnet "**navnNVEl.csv**".
...
### Vannlokaliteter
Fila over vannlokaliteter må lastes ned som en excel-fil (xlsx) fra vannmiljø-databasen:
...
Denne fila er nødvendig for å lese inn vannforekomstdataene, og den ligger i dette arkivet under navnet "**NavnVL.csv**".
...
Funksjonen som gjennomfører analysen, heter `fraVFtilNI` ("fra vannforkrift til naturindeks").
