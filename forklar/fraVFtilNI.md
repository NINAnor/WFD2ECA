...
- `maalingTyp` (**numerisk skalar**). Minste antall målinger som må foreligge for en typologifaktor for at det gjøres et forsøk på å inkludere typologifaktoren i modellen. Standardinnstillinga er 25. (Argumentet ble tilføyd i versjon 1.2.)
- `maalingInt` (**numerisk skalar**). Minste antall målinger som må foreligge for hver kombinasjon av to parametere for at en interaksjonen mellom dem testes i modellen. Standardinnstillinga er 25. (Argumentet ble tilføyd i versjon 1.4.)
...
- `logit` (**sannhetsverdi-skalar**). ¤¤¤ skal mEQR-verdier logit-transformeres for modelltilpasninga . (Argumentet ble tilføyd i versjon 1.4.)
...
- `interaksjon` (**sannhetsverdi-skalar**). Ved `interaksjon = TRUE` (standardinnstillinga) testes interaksjoner mellom rapporteringsperiode og de øvrige forklaringsvariablene under modellseleksjonen. Med `FALSE` droppes interaksjoner. (Argumentet ble tilføyd i versjon 1.4.)
