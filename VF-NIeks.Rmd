...
# Eksporten fra innsjødatabasen var for stor til å legge ut på GitHub.
...
Informasjonen må være lagret i to excel-regneark som heter "**knr.xlsx**" og "**fnr.xlsx**".
```{r}
source("AdminEnh.R")
```
...
Den har mange flere parametere enn de som vises under, som tillater ulike justeringer som er [forklart her](forklar.md).
De første fire parametrene må alltid oppgis.
Resten trenger man bare å oppgi om man ønsker å endre på standardinnstillingene (som også er [forklart her](forklar.md)).
