...
Forkortelsen for parameteren (her er det valgt "ASPT") oppgis som argument når målingene leses inn i R ved hjelp av funksjonen [`lesMaalinger`](forklar/lesMaalinger.md):
```{r}
